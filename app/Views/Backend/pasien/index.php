					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="add-row" class="display table table-striped table-hover" >
								...
								<tbody>
								<?php foreach($pasien as $index => $pasienlist): ?>
									<tr>
										<td><?= $index += 1 ?>.</td>
										...
										<td>
											<div class="form-button-action">
												...
												<button type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-danger delete_button" data-original-title="Remove" data-href="<?= base_url('adm/pasien/'.$pasienlist['id_pasien'].'/delete') ?>">
